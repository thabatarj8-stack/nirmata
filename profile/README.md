...
**[Nirmata](https://github.com/thabatarj8-stack/nirmata)** studies what final-output evaluation misses when AI agents use tools, cross authorization boundaries, change state, and create external effects.
