...
**Language:** English · [Português (Brasil)](EVIDENCE-STATUS.pt-BR.md)

| Record | Evidence class | Supported statement | Unsupported extrapolation |
|---|---|---|---|
| Experiment #001 editorial run | Exploratory observation | One run produced an acceptable draft while its trajectory contained an approval-attribution error | That output-only evaluation generally misses every authorization failure |
